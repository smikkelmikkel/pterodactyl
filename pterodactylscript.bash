...
mysql -u root -e "CREATE USER '${MYSQL_USER}'@'$FQDN' IDENTIFIED BY '${MYSQL_PASSWORD}';"
mysql -u root -e "CREATE DATABASE ${MYSQL_DATABASE};"
mysql -u root -e "GRANT ALL PRIVILEGES ON ${MYSQL_DATABASE}.* TO '${MYSQL_USER}'@'$FQDN' WITH GRANT OPTION;"
mysql -u root -e "FLUSH PRIVILEGES;"
mysql -u root -e "CREATE USER '${MYSQL_USER_PANEL}'@'$FQDN' IDENTIFIED BY '${MYSQL_PASSWORD_PANEL}';"
mysql -u root -e "GRANT ALL PRIVILEGES ON *.* TO '${MYSQL_USER_PANEL}'@'$FQDN' WITH GRANT OPTION;"
mysql -u root -e "FLUSH PRIVILEGES;"
...
php artisan p:environment:database --host=$FQDN --port=3306 --database=$MYSQL_DATABASE --username=$MYSQL_USER --password=$MYSQL_PASSWORD
